...
<body>
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item" href="#">Information session</a>
        ...
        <li>
        <button type= "submit" class="btn btn-rounded" style="width:100px; background-color:#12355B; color:#ffffff;" data-toggle="modal" data-target="#modalRegisterForm">Sign Up</button>
        </li>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-body mx-3">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button type= "submit" class="btn btn-rounded" style="width:100px; background-color:#12355B; color:#ffffff;">Sign Up</button>
            </div>
        </div>
    </div>
</div>
