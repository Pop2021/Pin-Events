...
INSERT INTO `P2021`.`Events` ( `eventName`, `Venue`, `Date`, `StartTime`, `EndTime`, `EventType`, `Description`) VALUES
('Rolling Smoke', 'The Hive', '2019-11-30', '18:00:00', '20:00:00', 'ASC', 'Come and enjoy good meat and music; meet new friends and have an amazing night.'),( 'Freaky Friday', 'On Campus Hostel', '2019-12-06', '07:00:00', '21:00:00', 'ASC', 'A fun day for you to switch places with any one in Ashesi. Have you ever wondered what it would be like to live the life of another person? Now is your chance.'),
