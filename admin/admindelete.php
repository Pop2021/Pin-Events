            ...
            <div class="card">
                ...
                <div class="card-body px-lg-5 pt-0">
                    ...
                    <form class="text-center" action="addeventproc.php" method="POST">
                        ...
                        <!-- Delete event button -->
                        <button type= "submit" name ="deleteevent" class="btn btn-rounded" style="width:100%; 
                        background-color:#12355B; color:#ffffff;" data-toggle="modal" data-target="#modalAdd">Delete</button>
                    </form>
                    <!-- Form -->
